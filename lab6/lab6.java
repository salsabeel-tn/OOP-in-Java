...
public class lab6 {
    public static void main (String[] args) {
        ...
        circle.Print();
        rectangle.Print();
        System.out.println(rectangle.getCornerLeftLow());
        System.out.println(rectangle.getCornerRightUpp());
        square.Print();
        System.out.println(square.getCornerLeftLow());
        System.out.println(square.getCornerRightUpp());
    }
